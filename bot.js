...
const QUESTIONS = [
    ...
    },
    {
        ...
        options: [
            { label: "Meno di $10k", value: "under_10k", emoji: "🟢" },
            { label: "$10k - $50k", value: "10k_50k", emoji: "🟡" },
            { label: "$50k+", value: "over_50k", emoji: "🟠" }
        ]
    },
    {
        id: 8,
    ...
    },
    {
        ...
        options: [
            { label: "Conservativa (<1%)", value: "conservativa", emoji: "🟢" },
            { label: "Moderata (1-2%)", value: "moderata", emoji: "🟡" },
